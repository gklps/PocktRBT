      ...
      <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
        ...
        <div className={`bg-${accentColor}-50 rounded-lg p-6`}>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button onClick={() => navigate('/send')} className={`flex items-center justify-center space-x-2 p-3 bg-${accentColor}-50 rounded-lg border border-${accentColor}-200 hover:bg-gray-200 transition-all duration-200`}>
              <ArrowUpRight className={`h-5 w-5 text-${accentColor}-600`}/>
              <span>Send</span>
            </button>
            <button onClick={() => navigate('/receive')} className={`flex items-center justify-center space-x-2 p-3 bg-${accentColor}-50 rounded-lg border border-${accentColor}-200 hover:bg-gray-200 transition-all duration-200`}>
